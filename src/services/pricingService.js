...
async function calculateDemandMultiplier(vehicleId, startDate, endDate) {
  try {
    ...
    //====================================================== Reuse logic from group 2 here =======================================================
    const availabilityQuery = 'SELECT COUNT(*) AS available_vehicles FROM availability WHERE vehicle_id = ? AND start_date <= ? AND end_date >= ?';
    const availabilityResult = await connection.query(availabilityQuery, [vehicleId, endDate, startDate]);
    //============================================================================================================================================
